  ...
  <yd-layout title="Cell">
    <yd-cell-group class="demo-small-pitch">
      <yd-cell-item>
        ...
        <input slot="right" type="text" placeholder="请输入您的姓名"> </yd-cell-item>
      <yd-cell-item arrow>
        <input slot="right" type="text" placeholder="请输入您的姓名"> </yd-cell-item>
      <yd-cell-item>
    ...
    <yd-cell-group title="多选">
      <yd-cell-item type="checkbox">
        ...
        <input slot="right" type="checkbox" value="Han MeiMei" v-model="checkedNames" /> </yd-cell-item>
      <yd-cell-item type="checkbox">
        <span slot="left">多选二</span>
        <input slot="right" type="checkbox" value="Li Lei" v-model="checkedNames" /> </yd-cell-item>
      <yd-cell-item type="checkbox">
        <span slot="left">多选三</span>
        <input slot="right" type="checkbox" value="Jim Green" v-model="checkedNames" /> </yd-cell-item>
      <yd-cell-item>
    ...
    <yd-cell-group title="单选">
      <yd-cell-item type="radio">
        ...
        <input slot="right" type="radio" value="Lili" v-model="picked" /> </yd-cell-item>
      <yd-cell-item type="radio">
        <span slot="left">单选二</span>
        <input slot="right" type="radio" value="Lucy" v-model="picked" /> </yd-cell-item>
      <yd-cell-item>
        <span slot="left">选中的值：</span>
