<template>
  <yd-layout title="Spinner">
    ...
    <div class="demo-spinner">
      ...
      <span class="demo-spinner-tip">[model: spinner1 =
        <strong>{{spinner1}}</strong>]</span>
    </div>
